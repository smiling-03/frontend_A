      ...
      <div className="overflow-hidden">
        <table className="min-w- text-left text-sm font-light ">
          <thead className="border-b font-medium dark:border-neutral-500">
              <h1 className="text-3xl w-full font-semibold text-left text-slate-800 uppercase decoration-bold ">1.2 Number of outgoing / final year students year-wise during last five years</h1>
          </thead>
          <tbody>
            <tr
              ...
              <th className="whitespace-nowrap px-6 py-4 w-2/3 uppercase font-medium text-slate-800 font-semibold decoration-bold">Number of students</th>
